...
python -m pip install torch==2.3.0 torchvision==0.18.0 fvcore==0.1.5.post20221221 iopath==0.1.9 hydra-core==1.3.2 omegaconf==2.3.0 opencv-python==4.9.0.80 einops==0.8.0 visdom==0.2.4 accelerate==0.24.0 plotly==5.22.0 pycolmap==0.5.0 && \
